...
Welcome to GoFrame documentation. This is your starting point for learning, building, and operating GoFrame applications.
...
Standard layout generated by `goframe new`:
