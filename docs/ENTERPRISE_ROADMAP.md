...
- [x] Tramo de paridad CLI con Django:
  ...
  - comandos nuevos `startapp`, `test`, `testserver`, `sqlmigrate`, `sqlflush`, `sqlsequencereset`, `flush`, `diffsettings`, `createcachetable`, `makemessages`, `compilemessages`, `collectstatic`, `findstatic`, `optimizemigration`, `squashmigrations`, `sendtestemail`, `inspectdb`, `dumpdata`, `loaddata`, `changepassword`, `clearsessions`
