...
- [x] Tramo de paridad CLI con Django:
  ...
  - comandos nuevos `startapp`, `test`, `testserver`, `sqlmigrate`, `sqlflush`, `sqlsequencereset`, `flush`, `diffsettings`, `createcachetable`, `remove_stale_contenttypes`, `makemessages`, `compilemessages`, `collectstatic`, `findstatic`, `optimizemigration`, `squashmigrations`, `sendtestemail`, `mailproviders`, `inspectdb`, `ogrinspect`, `dumpdata`, `loaddata`, `changepassword`, `clearsessions`
