...
- `admin_title`
- `admin_live_exclude_patterns` (default `[/admin]`)
- `admin_cluster_enabled` (default `false`)
- `admin_cluster_redis_url` (optional, fallback `redis_url`)
